-- =====================================================================
-- T-Stack — Dati demo (eseguire DOPO aver creato almeno un utente auth)
-- Nota: i profili nascono automaticamente dal trigger on_auth_user_created.
--       Qui popoliamo solo clienti / progetti / task / transazioni di esempio.
-- =====================================================================

insert into clients (id, name, contact_email, phone, notes) values
...
insert into projects (id, client_id, name, description, status, start_date, due_date, budget_amount) values
...
insert into transactions (project_id, type, amount, description, category, occurred_on) values
